                                ...
                                children: [
                                  ...
                                  ColorFiltered(
                                    ...
                                    child: Transform.scale(
                                      scale: zoomCount/100,
                                      child: FittedBox(
                                        child: Image.file(File(image!.path),fit: BoxFit.cover,width: 100,height: 150,
                                        ),
                                      ),
                                    ),
                                  ),
                        ...
                        child: Column(
                          children: [
                            ...
                            Container(
                              ...
                              child:
                              Text("are pleased to announce \n their marrieage",style: TextStyle(color: Colors.black26),textAlign: TextAlign.center,),
                            ),
                            Container(
                              margin:EdgeInsets.all(5),
                              padding: EdgeInsets.only(top: 5,bottom: 5,left: 15,right: 15),
                              ...
                              child:
                              Text("august 21 st | 2024 \n san dieago, ca",style: TextStyle(color: Colors.black26),textAlign: TextAlign.center,),
                            )
                          ],
                        ),
                      )
